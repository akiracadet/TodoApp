namespace TodoApp.Infrastructure.Extensions
{
    ...
    {
        public static bool IsSatisfied<T>(this List<Specification<T>> specifications)
        {
            var result = specifications.All(spec => spec.IsSatisfied());
            return result;
        }

        public static IEnumerable<string> Errors<T>(this List<Specification<T>> specifications)
        {
